    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        <div class="chart-wrapper">
          ...
          <div class="chart-stage" id = 'wrapper'>
            <a href="http://localhost/E-Invoice/Einvoice/public/invoices">  <button class="bigBtn btn btn-success" style="font-size: 80px; padding: 100px 80px; text-align:center;">Create New Invoice</button></a>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-6">
        <div class="chart-wrapper">
          ...
          <div class="chart-stage" id = 'wrapper'>
          <a href="http://localhost/E-Invoice/Einvoice/public/items">  <button class="bigBtn btn btn-primary" style="font-size: 80px; padding: 100px 150px; text-align:center;">Manage Items</button>  </a>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-12">
        <div class="chart-wrapper">
          ...
          <div class="chart-stage" id = 'wrapper'>
            <a href="http://localhost/E-Invoice/Einvoice/public/templs">  <button class="bigBtn btn btn-primary" style="font-size: 50px; padding: 80px 90px; text-align:center;">Manage Templates</button></a>
          </div>
        </div>
      </div>
